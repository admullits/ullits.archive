...
* @version $Id: help_faq.php,v 1.6 2008/05/26 10:23:19 jansk Exp $
...
$help = array(
	...
	array(
		...
		1 => 'Der kan være flere grunde til, at du ikke kan logge ind. Først bør du sikre dig, at du taster brugernavn og kodeord korrekt. Husk, at der skelnes mellem store og små bogstaver i kodeordet - kontrollér tasten "Caps Lock". Hvis oplysningerne er korrekte, bør du kontakte en boardadministrator for at få hjælp.'
	),
	array(
	...
	array(
		...
		1 => 'Hvis du har indstillet tidszone og sommertidsindstillingen/<abbr title="Daylight Saving Time">DST</abbr> korrekt og klokkeslæt stadig vises forkert, er det fordi serverens ur er indstillet forkert. Kontakt venligst en boardadministrator for at få fejlen korrigeret.'
	),
	array(
	...
	array(
		...
		1 => 'For et indsætte en signatur nederst i dit indlæg, skal du først oprette en signatur i brugerkontrolpanelet under din profil. Når den er oprettet, kan du markere boksen <em>Indsæt signatur</em> når du skriver indlægget. Du kan også vælge at der altid skal indsættes en signatur til dine indlæg, ved at gå ind i <em>Redigér skriveindstillinger</em> og vælge at signaturen skal tilføjes som standard. Hvis du gør dette, kan du stadig undgå at din signatur medtages i et specifikt indlæg ved at fravælge <em>Indsæt signatur</em> inden du indsender indlægget.'
	),
	array(
	...
	array(
		...
		1 => 'Det maksimale antal afstemningsmuligheder er indstillet af boardadministrator. Hvis du føler du har behov for at tilføje flere afstemningsmuligheder til din afstemning end tilladt, kontakt da venligst en boardadministrator.'
	),
	array(
		0 => 'Hvorfor kan jeg ikke få adgang til et forum?',
		1 => 'Nogle fora kan være begrænsede til udvalgte brugere eller grupper. For at læse og skrive i disse kræves specielle tilladelser. Kun forummets redaktører eller en boardadministrator kan give disse tilladelser. Du bør kontakte én af disse, hvis du mener at du bør have denne tilladelse.'
	),
	array(
	...
	array(
		...
		1 => 'Den giver dig mulighed for at gemme og dermed færdiggøre dit indlæg på et senere tidspunkt. For at få adgang til det eller de gemte, men ikke indsendte, indlæg senere, skal du gå til dit brugerkontrolpanel.'
	),
	array(
	...
	array(
		...
		1 => 'Hvis du er medlem af mere end én brugergruppe, vil din standardbrugergruppe være afgørende for hvilken gruppefarve og rang der vises for dig. En boardadministrator kan give dig tilladelse til at ændre din standardbrugergruppe i brugerkontrolpanelet.'
	),
	array(
	...
	array(
		...
		1 => 'I brugerkontrolpanelet kan du blokere en brugers mulighed for at sende dig private beskeder. Hvis du modtager grove eller generende beskeder fra en bestemt bruger, kan du informere administratorerne; de kan lukke for brugeres mulighed for at sende private beskeder.'
	),
	array(
	...
	array(
		...
		1 => 'Din søgning var formentlig for bred og indeholdt sikkert mange almindelige ord, som ikke indekseres af phpBB3. Prøv at søge mere specifikt og at bruge mulighederne i den avancerede søgning.'
	),
	array(
	...
	array(
		...
		1 => 'Dine egne indlæg kan listes ved at klikke på "Vis dine indlæg" øverst på boardindekset eller på brugerkontrolpanelets forside. For at søge dine emner bruges den avancerede søgning og udfyld de relevante søgekriterier i overenstemmelse hermed.'
	),
	array(
		0 => '--',
		1 => 'Bogmærker og overvågning af emner'
	),
	array(
		0 => 'Hvad er forskellen på at bogmærke og på at overvåge?',
		1 => 'Bogmærker i phpBB3 er at sammenligne med bogmærker i din browser. Du får ikke nødvendigvis en advisering når der er foretaget en opdatering, men du kan bruge bogmærket til nemt at finde tilbage til emnet senere. Hvis du derimod vælger at overvåge et emne, vil du modtage en advisering hvis der foretages en opdatering i et emne eller et forum med den eller de adviseringsmetoder du foretrækker.'
	),
	array(
