...
* @version $Id: install.php,v 1.9 2008/06/12 16:39:42 jansk Exp $
...
$lang = array_merge($lang, array(
	...
	'CONV_ERROR_ATTACH_FTP_DIR'			=> 'FTP-upload for vedhæftede filer er slået til på det gamle board. Slå muligheden for FTP-upload fra og sørg for at en gyldig uploadmappe er angivet, kopiér herefter venligst alle vedhæftede filer til denne nye mappe, der skal kunne tilgås fra serveren. Når du har du gjort dette, genstartes konverteren.',
	...
	'COULD_NOT_COPY'			=> 'Kunne ikke kopiere fil <strong>%1$s</strong> til <strong>%2$s</strong><br /><br />Kontrollér venligst at modtagemappen eksisterer og er skrivbar for serveren.',
	'COULD_NOT_FIND_PATH'		=> 'Kunne ikke finde stien til kildeboardet. Kontrollér venligst dine indstillinger og prøv igen.<br />» %s var angivet som kildesti.',
	...
	'DEFAULT_PREFIX_IS'			=> 'Konverteren kunne ikke finde tabeller med det angivne præfiks. Kontrollér venligst at du angivet de korrekte data for boardet du ønsker at konvertere. Standardtabelpræfiks for %1$s er <strong>%2$s</strong>.',
	...
	'INITIAL_CONFIG_EXPLAIN'	=> 'Nu hvor installationen har fastslået at din server kan køre phpBB, skal du indtaste nogle specifikke oplysninger. Hvis du ikke ved hvordan du forbinder til din database bedes du kontakte din vært (i første omgang) eller bruge supportforaene for phpBB. Kontrollér venligst indtastede data grundigt før du fortsætter.',
	'INSTALL_CONGRATS'			=> 'Tillykke!',
	'INSTALL_CONGRATS_EXPLAIN'	=> '
	<p>Du har nu installeret phpBB %1$s. Afhængig af hvad du vil med din nye installation af phpBB3, har du nu to muligheder:</p>
	...
	<p>Klik på knappen nedenfor som leder dig til administratorkontrolpanelet (ACP). Giv dig tid til at gennemgå de indstillinger du har til rådighed. Husk at der er hjælp at hente online via den engelske <a href="http://www.phpbb.com/support/documentation/3.0/">dokumentation</a> og i <a href="http://www.phpbb.com/community/viewforum.php?f=46">supportforaene</a>, se også i <a href="%3$s">README</a> for yderligere information.</p><p><strong>Slet, flyt eller omdøb venligst nu install-mappen før du bruger dit board. Hvis denne mappe stadig er til stede, vil kun administratorkontrolpanelet (ACP) være tilgængeligt.</strong></p>',
	...
	'INST_ERR_DB_NO_ORACLE'		=> 'Den installerede version af Oracle på denne server kræver at du sætter parameteren <var>NLS_CHARACTERSET</var> til <var>UTF8</var>. Opdatér venligst enten din installation til 9.2+ eller korrigér indstilllingen af parameteren.',
	...
	'SEARCH_INDEX_UNCONVERTED_EXPLAIN'	=> 'Dit gamle søgeindeks blev ikke konverteret. Udføres der i øjeblikket en søgning, vil den ikke give nogle træffere. For at oprette et nyt søgeindeks skal du i administratorkontrolpanelet vælge "Vedligehold" og "Søgeindeks" i undermenuen.',
	...
	'STAGE_CREATE_TABLE_EXPLAIN' => 'Databasetabellerne, der anvendes af phpBB 3.0, er dannet og udfyldt med nogle indledende data. Fortsæt til næste trin for at afslutte installationen af phpBB.',
...
$lang = array_merge($lang, array(
	...
	'CURRENT_FILE'					=> 'Starten af nuværende original fil',
	...
	'DIFF_SEP_EXPLAIN'					=> 'Enden af nuværende original fil / starten af ny opdateret fil',
	...
	'NEW_FILE'						=> 'Slut på ny opdateret fil',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Den hér beskrevne metode for opdatering af din installation, gælder kun for opdatering med den automatiske opdateringspakke. Der findes to andre opdateringsmetoder, de er beskrevet i INSTALL.html. For at udføre en automatisk opdatering, skal disse trin udføres:</p>
