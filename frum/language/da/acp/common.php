...
/**
*
* acp_common.php [Danish]
*
* @package language
* @version Id: common.php 8591 2008-06-04 11:40:53Z Kellanved $
* @version $Id: common.php,v 1.10 2008/07/11 19:32:48 jansk Exp $
...
$lang = array_merge($lang, array(
	...
	'ACP_ADMIN_ROLES'			=> 'Administratorrolle',
	...
	'ACP_PERMISSION_MASKS'		=> 'Tilladelsesmasker',
	...
	'ACP_USER_FEEDBACK'				=> 'Brugernotater',
	'ACP_USER_GROUPS'				=> 'Grupper',
	'ACP_USER_MANAGEMENT'			=> 'Brugeradministration',
	'ACP_USER_OVERVIEW'				=> 'Brugerliste',
	'ACP_USER_PERM'					=> 'Brugertilladelser',
	'ACP_USER_PREFS'				=> 'Brugerindstillinger',
	'ACP_USER_PROFILE'				=> 'Brugerprofil',
	'ACP_USER_RANK'					=> 'Rangorden',
	'ACP_USER_ROLES'				=> 'Brugerrolle',
	...
	'ACP_VIEW_FORUM_MOD_PERMISSIONS'	=> 'Se redaktørtilladelser',
	...
	'SETTING_TOO_LOW'	=> 'Den indtastede værdi for indstillingen "%1$s" er for lav. Mindste tilladte værdi er %2$d.',
	'SETTING_TOO_BIG'		=> 'Den indtastede værdi for indstillingen "%1$s" er for høj. Højeste tilladte værdi er %2$d.',	
	'SETTING_TOO_LONG'	=> 'Den indtastede værdi for indstillingen "%1$s" er for lang. Længste tilladte værdi er %2$d.',
	'SETTING_TOO_SHORT'	=> 'Den indtastede værdi for indstillingen "%1$s" er ikke lang nok. Korteste tilladte værdi er %2$d.',
...
$lang = array_merge($lang, array(
	...
	'ADMIN_LOG_INDEX_EXPLAIN'	=> 'De seneste 5 handlinger udført af administratorer. Den fulde log kan vises ved at klikke på linket herunder "se administratorlog". Denne og alle øvrige logs kan også ses via fanebladet "Vedligehold".',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_USERS_EXPLAIN_INDEX'	=> 'De seneste 10 tilmeldte brugere med inaktive konti. En fuldstændig liste er tilgængelig ved at følge linket nedenfor, hvorfra du kan aktivere, slette eller erindre disse brugere pr. email hvis du ønsker det. Listen kan også ses via fanebladet "Brugere & Grupper".',
...
$lang = array_merge($lang, array(
	...
	'LOG_ACL_ADD_FORUM_LOCAL_F_'		=> '<strong>Tilføjet eller ændret forumtilladelser</b fra %1$s<br />» %2$s',
	...
	'LOG_ADMIN_AUTH_FAIL'		=> '<strong>Forsøgt forgæves login som administrator</strong>',
	...
	'LOG_SPLIT_SOURCE'			=> '<strong>Delt indlæg</strong><br />» fra %s',
	...
	'LOG_DB_BACKUP'			=> '<strong>Udført databasebackup</strong>',
	'LOG_DB_DELETE'			=> '<strong>Slettet databasebackup</strong>',
	'LOG_DB_RESTORE'		=> '<strong>Gendannet database</strong>',
	...
	'LOG_GROUP_CREATED'		=> '<strong>Oprettet ny gruppe</strong><br />» %s',
	'LOG_GROUP_DEFAULTS'	=> '<strong>Ændret gruppe "%1$s" til standardgruppe for</strong><br />» %2$s',
	'LOG_GROUP_DELETE'		=> '<strong>Slettet gruppe</strong><br />» %s',
	'LOG_GROUP_DEMOTED'		=> '<strong>Degraderet gruppeleder i gruppe</strong> %1$s<br />» %2$s',
	'LOG_GROUP_PROMOTED'	=> '<strong>Forfremmet medlemmer til leder af gruppe</strong> %1$s<br />» %2$s',
	'LOG_GROUP_REMOVE'		=> '<strong>Fjernet medlemmer fra gruppe</strong> %1$s<br />» %2$s',
	'LOG_GROUP_UPDATED'		=> '<strong>Opdateret gruppeinformation</strong><br />» %s',
	'LOG_MODS_ADDED'		=> '<strong>Tilføjet ledere af gruppe</strong> %1$s<br />» %2$s',
	'LOG_USERS_APPROVED'	=> '<strong>Godkendt medlemmer i gruppe</strong> %1$s<br />» %2$s',
	'LOG_USERS_ADDED'		=> '<strong>Føjet nye medlemmer til gruppe</strong> %1$s<br />» %2$s',

	'LOG_IMAGESET_ADD_DB'		=> '<strong>Føjet billedpakke til database</strong><br />» %s',
	'LOG_IMAGESET_ADD_FS'		=> '<strong>Føjet billedpakke til filsystem</strong><br />» %s',
	'LOG_IMAGESET_DELETE'		=> '<strong>Slettet billedpakke</strong><br />» %s',
	'LOG_IMAGESET_EDIT_DETAILS'	=> '<strong>Ændret billedpakkeinformation</strong><br />» %s',
	'LOG_IMAGESET_EDIT'			=> '<strong>Ændret billedpakke</strong><br />» %s',
	'LOG_IMAGESET_EXPORT'		=> '<strong>Eksporteret billedpakke</strong><br />» %s',
	'LOG_IMAGESET_LANG_MISSING'	=> '<strong>Billedpakke mangler "%2$s" sprog</strong><br />» %1$s',
	'LOG_IMAGESET_LANG_REFRESHED'	=> '<strong>Genopfrisket "%2$s" sprogspecifik billedpakke</strong><br />» %1$s',
	'LOG_IMAGESET_REFRESHED'	=> '<strong>Genopfrisket billedpakke</strong><br />» %s',
	...
	'LOG_LANGUAGE_PACK_INSTALLED'	=> '<strong>Installeret sprogpakke</strong><br />» %s',
	...
	'LOG_MCP_CHANGE_POSTER'	=> '<strong>Ændret forfatter i emne "%1$s"</strong><br />» fra %2$s til %3$s',

	'LOG_MODULE_DISABLE'	=> '<strong>Slået modul fra</strong><br />» %s',
	'LOG_MODULE_ENABLE'		=> '<strong>Slået modul til</strong><br />» %s',
	'LOG_MODULE_MOVE_DOWN'	=> '<strong>Flyttet modul ned</strong><br />» %1$s under %2$s',
	'LOG_MODULE_MOVE_UP'	=> '<strong>Flyttet modul op</strong><br />» %1$s over %2$s',
	'LOG_MODULE_REMOVED'	=> '<strong>Fjernet modul</strong><br />» %s',
	'LOG_MODULE_ADD'		=> '<strong>Tilføjet modul</strong><br />» %s',
	'LOG_MODULE_EDIT'		=> '<strong>Ændret modul</strong><br />» %s',

	'LOG_A_ROLE_ADD'		=> '<strong>Tilføjet administratorrolle</strong><br />» %s',
	'LOG_A_ROLE_EDIT'		=> '<strong>Ændret administratorrolle</strong><br />» %s',
	'LOG_A_ROLE_REMOVED'	=> '<strong>Fjernet administratorrolle</strong><br />» %s',
	'LOG_F_ROLE_ADD'		=> '<strong>Tilføjet forumrolle</strong><br />» %s',
	'LOG_F_ROLE_EDIT'		=> '<strong>Ændret forumrolle</strong><br />» %s',
	'LOG_F_ROLE_REMOVED'	=> '<strong>Fjernet forumrolle</strong><br />» %s',
	'LOG_M_ROLE_ADD'		=> '<strong>Tilføjet redaktørrolle</strong><br />» %s',
	'LOG_M_ROLE_EDIT'		=> '<strong>Ændret redaktørrolle</strong><br />» %s',
	'LOG_M_ROLE_REMOVED'	=> '<strong>Fjernet redaktørrolle</strong><br />» %s',
	'LOG_U_ROLE_ADD'		=> '<strong>Tilføjet brugerrolle</strong><br />» %s',
	'LOG_U_ROLE_EDIT'		=> '<strong>Ændret brugerrolle</strong><br />» %s',
	'LOG_U_ROLE_REMOVED'	=> '<strong>Fjernet brugerrolle</strong><br />» %s',

	'LOG_PROFILE_FIELD_ACTIVATE'	=> '<strong>Aktiveret profilfelt</strong><br />» %s',
	'LOG_PROFILE_FIELD_CREATE'		=> '<strong>Tilføjet profilfelt</strong><br />» %s',
	'LOG_PROFILE_FIELD_DEACTIVATE'	=> '<strong>Deaktiveret profilfelt</strong><br />» %s',
	'LOG_PROFILE_FIELD_EDIT'		=> '<strong>Ændret profilfelt</strong><br />» %s',
	'LOG_PROFILE_FIELD_REMOVED'		=> '<strong>Fjernet profilfelt</strong><br />» %s',

	'LOG_PRUNE'					=> '<strong>Beskåret fora</strong><br />» %s',
	'LOG_AUTO_PRUNE'			=> '<strong>Autobeskåret fora</strong><br />» %s',
	...
	'LOG_RANK_ADDED'			=> '<strong>Tilføjet rang</strong><br />» %s',
	'LOG_RANK_REMOVED'			=> '<strong>Slettet rang</strong><br />» %s',
	'LOG_RANK_UPDATED'			=> '<strong>Opdateret rang</strong><br />» %s',

	'LOG_REASON_ADDED'		=> '<strong>Tilføjet afvisningsbegrundelse</strong><br />» %s',
	'LOG_REASON_REMOVED'	=> '<strong>Fjernet afvisningsbegrundelse</strong><br />» %s',
	'LOG_REASON_UPDATED'	=> '<strong>Opdateret afvisningsbegrundelse</strong><br />» %s',
	...
	'LOG_RESET_DATE'			=> '<strong>Nulstillet boardets startdato</strong>',
	'LOG_RESET_ONLINE'			=> '<strong>Nulstillet "Flest brugere online"</strong>',
	'LOG_RESYNC_POSTCOUNTS'		=> '<strong>Resynkroniseret indlægstæller for brugere</strong>',
	'LOG_RESYNC_POST_MARKING'	=> '<strong>Resynkroniseret prikkede emner</strong>',
	'LOG_RESYNC_STATS'			=> '<strong>Resynkroniseret indlægs-, emne- og brugerstatistikker</strong>',
	...
	'LOG_STYLE_ADD'				=> '<strong>Tilføjet typografi</strong><br />» %s',
	'LOG_STYLE_DELETE'			=> '<strong>Slettet typografi</strong><br />» %s',
	'LOG_STYLE_EDIT_DETAILS'	=> '<strong>Ændret typografi</strong><br />» %s',
	'LOG_STYLE_EXPORT'			=> '<strong>Eksporteret typografi</strong><br />» %s',
	...
	'LOG_TEMPLATE_CACHE_CLEARED'	=> '<strong>Tømt cacheversioner af skabelonfiler i skabelon <i>%1$s</i></strong><br />» %2$s',
	'LOG_TEMPLATE_DELETE'			=> '<strong>Slettet skabelon</strong><br />» %s',
	...
	'LOG_TEMPLATE_EXPORT'			=> '<strong>Eksporteret skabelon</strong><br />» %s',
	'LOG_TEMPLATE_REFRESHED'		=> '<strong>Genopfrisket skabelon</strong><br />» %s',

	'LOG_UPDATE_DATABASE'		=> '<strong>Opdateret database fra version %1$s til version %2$s</strong>',
	'LOG_UPDATE_PHPBB'			=> '<strong>Opdateret phpBB fra version %1$s til version %2$s</strong>',

	'LOG_THEME_ADD_DB'			=> '<strong>Føjet tema til database</strong><br />» %s',
	'LOG_THEME_ADD_FS'			=> '<strong>Føjet tema til filsystem</strong><br />» %s',
	'LOG_THEME_DELETE'			=> '<strong>Slettet tema</strong><br />» %s',
	...
	'LOG_THEME_REFRESHED'		=> '<strong>Genopfrisket tema</strong><br />» %s',

	'LOG_USER_ACTIVE'		=> '<strong>Aktiveret bruger</strong><br />» %s',
	'LOG_USER_BAN_USER'		=> '<strong>Udelukket bruger via Administrér brugere </strong> på grund af "<i>%1$s</i>"<br />» %2$s',
	'LOG_USER_BAN_IP'		=> '<strong>Udelukket IP-adresse via Administrér brugere</strong> på grund af "<i>%1$s</i>"<br />» %2$s',
	'LOG_USER_BAN_EMAIL'	=> '<strong>Udelukket emailadresse via Administrér brugere</strong> på grund af "<i>%1$s</i>"<br />» %2$s',
	...
	'LOG_USER_NEW_PASSWORD'	=> '<strong>Ændret kodeord for bruger</strong><br />» %s',
	'LOG_USER_REACTIVATE'	=> '<strong>Gennemtvunget genaktivering af konto for bruger</strong><br />» %s',
	'LOG_USER_UPDATE_EMAIL'	=> '<strong>Ændret emailadresse for bruger "%1$s"</strong><br />» fra "%2$s" til "%3$s"',
	'LOG_USER_UPDATE_NAME'	=> '<strong>Ændret brugernavn</strong><br />» fra "%1$s" til "%2$s"',
	'LOG_USER_USER_UPDATE'	=> '<strong>Opdateret information om bruger</strong><br />» %s',
	...
	'LOG_USER_WARNING'			=> '<strong>Tilføjet brugeradvarsel</strong><br />» %s',
	...
	'LOG_USER_GROUP_DEMOTE'			=> '<strong>Bruger degraderet som leder af gruppe</strong><br />» %s',
