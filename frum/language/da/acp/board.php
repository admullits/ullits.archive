...
* @version $Id: board.php,v 1.6 2008/06/12 15:46:27 jansk Exp $
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BIRTHDAYS_EXPLAIN'	=> 'Tillad angivelse af fødseldato og at alder vises i brugerprofiler. Bemærk at visning af fødselsdagslisten nederst på boardindekset kontrolleres af en særskilt indstilling under Serverkonfiguration -> Belastning.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_FLASH_PM'			=> 'Tillad brug af BBkode-tag\'en <code>[FLASH]</code> i private beskeder',
	'ALLOW_FLASH_PM_EXPLAIN'	=> 'Bemærk at for at muligheden for at anvende flash i private beskeder her skal træde i kraft, skal muligheden for at anvende flash også være tilladt i de overordnede tilladelsesindstillinger.',
...
$lang = array_merge($lang, array(
	...
	'YES_BIRTHDAYS_EXPLAIN'			=> 'Hvis der vælges "Nej" vises fødseldagslisten ikke på boardindekset. For at aktivere visning af listen forudsætter det at visning af fødselsdag også er tilvalgt under boardkonfiguration.',
	'YES_JUMPBOX'					=> 'Aktivér visning af hop-til-boks',
	'YES_MODERATORS'				=> 'Aktivér visning af redaktører',
	'YES_ONLINE'					=> 'Aktivér onlinestatus for tilmeldte brugere',
	'YES_ONLINE_EXPLAIN'			=> 'Vis onlinestatus for tilmeldte brugere på boardindeks, forum og emnesider.',
	'YES_ONLINE_GUESTS'				=> 'Aktivér onlinestatus for gæster',
	'YES_ONLINE_GUESTS_EXPLAIN'		=> 'Vis gæster i "Hvem er online".',
	'YES_ONLINE_TRACK'				=> 'Aktivér online/offlinestatus for tilmeldte brugere',
	'YES_ONLINE_TRACK_EXPLAIN'		=> 'Vis online/offlinestatus for tilmeldte brugere i profiler og på emnesider.',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'           => 'Det genererede indhold bliver komprimeret inden afsendelse til brugeren. Det kan medvirke til at mindske netværkstrafikken, og dermed også båndbreddeforbruget, til gengæld øges belastningen af både serverens og brugerens CPU.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_AUTOLOGIN_EXPLAIN'		=> 'Bestemmer om brugere kan logge automatisk ind når de besøger boardet.',
	...
	'FORM_TIME_MAX_EXPLAIN'			=> 'Tiden en bruger har til at indsende en fomular. Sæt til -1 for at slå indstillingen fra. Bemærk at en formular kan blive ugyldig hvis sessionen udløber, uanset denne indstilling.',
	'FORM_SID_GUESTS'				=> 'Knyt formularer til gæstesessioner',
	'FORM_SID_GUESTS_EXPLAIN'		=> 'Hvis "Ja", vil formularens token udgivet til gæster blive baseret på enkeltsessioner. Bemærk at denne indstilling kan give problemer i forhold til nogle værter.',
	...
	'TPL_ALLOW_PHP_EXPLAIN'			=> 'Hvis denne indstilling er aktiveret, vil kommandoerne <code>PHP</code> og <code>INCLUDEPHP</code> i skabelonfilerne blive genkendt og behandlet.',
));
