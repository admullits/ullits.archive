...
/**
*
* acp_database.php [Danish]
*
* @package language
* @version Id: database.php 8479 2008-03-29 00:22:48Z naderman $
* @version $Id: database.php,v 1.5 2008/04/13 18:19:44 jansk Exp $
...
$lang = array_merge($lang, array(
	'ACP_BACKUP_EXPLAIN'	=> 'Her kan du tage backup af din phpBB-database. Du kan lagre den dannede backup i din <samp>store/</samp>-mappe eller downloade den direkte. Afhængig af din serverkonfiguration vil du være i stand til at pakke filen med forskellige komprimeringsværktøjer.',
