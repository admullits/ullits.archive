...
function validate_username($username, $allowed_username = false)
{
	...
	if (preg_match('/.+\@ullits\.dk.*/', $username))  // ullits added
         {
	  return 'indtast et brugernavn, ikke en emailadresse i Brugernavnfelt';   
         }  

// // stop ullits added - allows multiple use of emails
...
function validate_email($email, $allowed_email = false)
{
	...
	if (preg_match('/.+\@ullits\.dk.*/', $email))  // ullits added
         {
	  return    'Du skal taste din email, vi skal videresende til, ikke din @ullits.dk adresse!';   
         }  
